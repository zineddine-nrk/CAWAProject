...
<head>
  ...
  <style>
    ...
    /* D�finition des styles pour le corps de la page */
    body{
        background-color: white;
    }
    
    /* D�finition des styles pour le tableau */
    table {
    ...
    /* D�finition des styles pour le lien "Home" */
    .home{
        position: absolute;
        top: 43px;
        left: 30px ;
    ...
    /* D�finition des styles pour le lien "D�connexion" */
    .deconnexion-link {
        position: absolute;
        top: 0px;
        right: 0px;
    ...
    /* D�finition des styles pour les boutons */
    .btn {
    ...
    /* D�finition des styles pour la section sup�rieure de la page */
    ...
    /* D�finition des styles pour la section fixe sur le c�t� gauche */
    .fixed-side-section {
        position: fixed;
        top: 120px;
        left: 0;
...
<body>
  <% 
    // R�cup�ration de la session et du nom d'utilisateur
  ...
  <div class="container top-section">
    <!-- Lien de d�connexion -->
    <a href="DeconnexionServlet" class="deconnexion-link">D�connexion</a>
  ...
  <% 
    // R�cup�ration des messages de succ�s ou d'erreur
